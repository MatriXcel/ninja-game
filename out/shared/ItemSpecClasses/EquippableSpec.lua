...
local EquippableSpecDecorator = TS.import(script, game:GetService("ReplicatedStorage"), "TS", "ItemSpecClasses", "EquippableSpecDecorator").EquippableSpecDecorator
local ItemSpec = TS.import(script, game:GetService("ReplicatedStorage"), "TS", "ItemSpecClasses", "ItemSpec").ItemSpec
local ModelVisualizableSpecDecorator = TS.import(script, game:GetService("ReplicatedStorage"), "TS", "ItemSpecClasses", "ModelVisualizableSpecDecorator").ModelVisualizableSpecDecorator
