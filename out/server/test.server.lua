...
local HealEffect = TS.import(script, game:GetService("ServerScriptService"), "TS", "Effects", "HealEffect").HealEffect
...
local holySword = HealSpecDecorator.new(EquippableSpec.new(Instance.new("Model"), "Holy Sword", "a holy sword of the paladins", 20), HealEffect.new(RawBonus.new(10, 0)))
